...
unsigned long long wxInvalidSize = (unsigned)-1;
...
/* static */
unsigned long long wxFileName::GetSize(const wxString &filename)
{
    ...
    return unsigned long long(lpFileSizeHigh, ret);
#else // ! __WIN32__
    wxStructStat st;
...
unsigned long long wxFileName::GetSize() const
{
