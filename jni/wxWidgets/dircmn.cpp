...
extern unsigned long long wxInvalidSize;
...
public:
    ...
    virtual wxDirTraverseResult OnFile(const wxString& filename)
    {
        unsigned long long sz = wxFileName::GetSize(filename);
...
unsigned long long wxDir::GetTotalSize(const wxString &dirname, wxArrayString *filesSkipped)
{
