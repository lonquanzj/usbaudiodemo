...
public class USBControl {
  ...
  public boolean startUSBTransfers(boolean i_playAudio, boolean i_recordAudio, int i_sampleRate, boolean i_force1PPT, int i_bufferSizeInFrames, int i_openSLESBufferSizeInFrames) {
    return USBTestNativeJNI.USBControl_startUSBTransfers(swigCPtr, this, i_playAudio, i_recordAudio, i_sampleRate, i_force1PPT, i_bufferSizeInFrames, i_openSLESBufferSizeInFrames);
  }
